...
class ModelTrainer:
    ...
    def initiate_model_trainer(self):
        try:
            ...
            # Start an MLflow run outside of strategy scope
            mlflow.start_run()  
            ...
            # Load the pre-trained Roberta model for sequence classification (outside strategy)
            ...
            with strategy.scope():
                ...
                optimizer = tf.keras.optimizers.Adam(learning_rate=self.trainer_config.learning_rate, epsilon=1e-08)
